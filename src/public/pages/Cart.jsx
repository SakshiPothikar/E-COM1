                    ...
                    <div class="bg-white shadow">
                        <div class="px-4 py-6 sm:px-8 sm:py-10">
                            <div class="flow-root">
                                <ul class="-my-8">
                                    {
                                        cart && cart.map(item => <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                                            <div class="shrink-0">
                                                <img class="w-24 max-w-full rounded-lg object-cover" src={item.image} alt="" />
                                            </div>
                            ...
                            <div class="mt-6 border-t border-b py-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="text-lg font-semibold text-gray-900"><span>{cart && cart.reduce((sum, item) => sum + (item.qty * item.price), 0)}</span></p>
                                </div>
                                <div class="flex items-center justify-between">
                            ...
                            <div class="mt-6 flex items-center justify-between">
                                ...
                                <p class="text-2xl font-semibold text-gray-900"><span class="text-xs font-normal text-gray-400">{cart && cart.reduce((sum, item) => sum + (item.qty * item.price), 800)}</span> 408.00</p>
                            </div>
