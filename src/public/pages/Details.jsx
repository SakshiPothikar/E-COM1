                ...
                <div class="container px-5 py-24 mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2  ">
                        <div className='flex flex-col md:flex-row gap-2 items-start'>
                            ...
                            <img alt="ecommerce" class="order-1 object-cover md:order-2 md:w-4/5 flex-1 object-center rounded" src={selectedProduct.image} />
                        </div>
                            ...
                            <div class="flex mb-4">
                                <span class="flex items-center">
                                    <div className="rating">
                                        <input type="radio" name="rating-1" className="bg-yellow-300 mask mask-star" />
                                        <input type="radio" name="rating-1" className="bg-yellow-300 mask mask-star" />
                                        <input type="radio" name="rating-1" className="bg-yellow-300 mask mask-star" />
                                        <input type="radio" name="rating-1" className="bg-yellow-300 mask mask-star" checked />
                                        <input type="radio" name="rating-1" className="bg-yellow-300 mask mask-star" />
                                    </div>
...
// flex box madhe order change krta yete----by default order aste 1